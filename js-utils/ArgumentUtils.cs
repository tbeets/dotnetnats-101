...
namespace js_utils
{
    public class ArgumentHelper
    {
        ...
        internal bool _delayUnlimitedFlag;
        ...
        public void DisplayBanner()
        {
            ...
            _banner("Delay", Delay, _delayUnlimitedFlag);
    ...
    public class ArgumentHelperBuilder
    {
        ...
        public ArgumentHelperBuilder DefaultDelay(int i, bool unlimitedFlag)
        {
            argumentHelper.Delay = i;
            argumentHelper._delayUnlimitedFlag = unlimitedFlag;
            return this;
        }
 
        public ArgumentHelperBuilder DefaultDelay(int i)
        {
            argumentHelper.Delay = i;
            return this;
        }
